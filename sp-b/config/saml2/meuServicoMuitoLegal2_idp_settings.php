...
$this_idp_env_id = 'meuServicoMuitoLegal2';
...
return $settings = array(
    ...
    'idp' => array(
        ...
        'x509cert' => env('SAML2_'.$this_idp_env_id.'_IDP_x509', env('SAML2_'.$this_idp_env_id.'_x509_FINGERPRINT')),
        /*
         *  Instead of use the whole x509cert you can use a fingerprint
         *  (openssl x509 -noout -fingerprint -in "idp.crt" to generate it)
         */
        // 'certFingerprint' => env('SAML2_'.$this_idp_env_id.'_x509_FINGERPRINT'),
    ),
    ...
    'contactPerson' => array(
        'technical' => array(
            'givenName' => 'Adriano',
            'emailAddress' => 'adriano_mail@hotmail.com'
        ),
        'support' => array(
            'givenName' => 'Adriano',
            'emailAddress' => 'adriano_mail@hotmail.com'
    ...
    'organization' => array(
        'en-US' => array(
            'name' => 'Ambra',
            'displayname' => 'Ambra Gaming',
            'url' => 'http://ambragaming.com'
        ),
    ),
