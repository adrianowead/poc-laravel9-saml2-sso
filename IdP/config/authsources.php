...
$config = [
    ...
    */
    ...
    'auth-usuarios-sql' => [
        'sqlauth:SQL',
        'dsn' => 'mysql:host=mysql;port=3306;dbname=meu_auth_db',
        'username' => 'root',
        'password' => 'root',
        'query' => 'SELECT uid, name, email FROM tb_users WHERE email = :username AND password = AES_ENCRYPT(CONCAT((SELECT salt FROM tb_users WHERE email = :username), :password), "727640ffa77f7a33fa06d2fb");',
    ],
